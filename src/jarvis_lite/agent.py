    ...
    def _help(self) -> str:
        return "\n".join(
            [
                ...
                "/config-candidate-confirm 编号：确认固化联系人别名或应用别名候选",
                "/config-candidate-undo 编号：撤销已固化联系人别名或应用别名候选",
    ...
    def _status(self) -> str:
        return "\n".join(
            [
                ...
                "- 确认候选：/config-candidate-confirm 编号 确认固化联系人别名或应用别名候选",
                "- 撤销固化：/config-candidate-undo 编号 删除联系人别名或应用别名并恢复候选",
