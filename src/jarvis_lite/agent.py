    ...
    def _help(self) -> str:
        return "\n".join(
            [
                ...
                "/config-candidate-confirm 编号：确认固化联系人别名、应用别名或授权规则候选",
                "/config-candidate-undo 编号：撤销已固化联系人别名、应用别名或授权规则候选",
    ...
    def _status(self) -> str:
        return "\n".join(
            [
                ...
                "- 确认候选：/config-candidate-confirm 编号 确认固化联系人别名、应用别名或授权规则候选",
                "- 撤销固化：/config-candidate-undo 编号 删除联系人别名、应用别名或授权规则并恢复候选",
