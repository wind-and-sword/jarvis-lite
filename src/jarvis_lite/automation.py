...
def describe_automation(paths: ProjectPaths) -> str:
    ...
    lines = [
        ...
        "- 日报目录：word",
        "- 当前能力：/dir-add、/dirs、/recent-files、/daily-report、/organize-preview、/dir-open、/hotkey、/mouse-click、/type-text、/window-focus、/app-launch、/chrome-open、/chrome-search、/clash-open、/clash-focus",
        "- 硬件入口：摄像头、麦克风暂缓",
    ]
    if directories:
        lines.append("- 常用目录列表：")
