...
- 安装完成弹窗会显示 `Jarvis Lite <版本号> installation finished`，用于确认新安装包已经生效；本轮测试包为 `0.104.0`，新增应用注册表第一阶段，可用 `/apps` 查看五个首批常用应用，用 `/app-find 名称或别名` 做只读匹配；完整进度见 `word/progress/2026-06-03.md`。
