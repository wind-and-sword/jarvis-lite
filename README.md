...
- 安装完成弹窗会显示 `Jarvis Lite <版本号> installation finished`，用于确认新安装包已经生效；本轮测试包为 `0.107.0`，新增 OCR 图片识别第一阶段，可用 `/ocr-status` 诊断 Tesseract CLI，用 `/ocr-image 图片路径 [lang=chi_sim+eng]` 识别已存在图片；完整进度见 `word/progress/2026-06-03.md`。
