...
- 安装完成弹窗会显示 `Jarvis Lite <版本号> installation finished`，用于确认新安装包已经生效；本轮测试包为 `0.113.0`，新增应用启动自动化第一阶段，可用 `/app-launch 应用名称或别名` 启动已登记且有可用路径的应用；完整进度见 `word/progress/2026-06-03.md`。
