...
- 通过 `/automation-status`、`/recent-files`、`/dir-add`、`/dirs`、`/daily-report`、`/organize-preview` 和 `/dir-open` 使用阶段 4 第一批工作台自动化能力；未登记常用目录时，也能用“查看最近文件”“打开桌面/下载目录/项目目录”“整理桌面/下载目录/项目目录”识别系统常见目录。
