...
- [2026-06-03-v128-memory-config-candidate-apply-plan.md](2026-06-03-v128-memory-config-candidate-apply-plan.md)：当前方案版本，明确 `0.123.0` 记忆与配置候选固化第一阶段、显式固化长期记忆/经验记忆/常用目录和不自动写入高风险配置边界。
