...
- [2026-06-03-v127-memory-config-candidates-plan.md](2026-06-03-v127-memory-config-candidates-plan.md)：当前方案版本，明确 `0.122.0` 记忆与配置候选池第一阶段、显式候选记录/查看/忽略和不自动写入长期配置边界。
