...
- [2026-06-03-v134-memory-config-high-risk-candidate-draft-plan.md](2026-06-03-v134-memory-config-high-risk-candidate-draft-plan.md)：当前方案版本，明确 `0.129.0` 高风险记忆与配置候选确认草稿第一阶段、确认草稿、撤销入口和不写入长期配置边界。
