...
- [2026-06-03-v133-memory-config-candidate-restore-plan.md](2026-06-03-v133-memory-config-candidate-restore-plan.md)：当前方案版本，明确 `0.128.0` 记忆与配置候选恢复第一阶段、已忽略/已固化候选历史和只恢复候选状态边界。
