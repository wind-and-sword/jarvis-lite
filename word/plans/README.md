...
- [2026-06-03-v131-task-failure-next-step-plan.md](2026-06-03-v131-task-failure-next-step-plan.md)：当前方案版本，明确 `0.126.0` 任务失败复盘行动建议第一阶段、缺少屏幕/OCR 时提示显式补采集和不自动重放外部动作边界。
