...
- [2026-06-05-v139-preference-confirmation-plan.md](2026-06-05-v139-preference-confirmation-plan.md)：当前方案版本，明确 `0.134.0` 偏好确认固化与撤销第一阶段、显式确认、撤销恢复和不改变回复或执行决策边界。
