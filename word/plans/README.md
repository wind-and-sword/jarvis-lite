...
- [2026-06-05-v138-authorization-rule-confirmation-plan.md](2026-06-05-v138-authorization-rule-confirmation-plan.md)：当前方案版本，明确 `0.133.0` 授权规则确认固化与撤销第一阶段、显式确认、撤销恢复和不改变执行决策边界。
